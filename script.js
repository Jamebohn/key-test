document.addEventListener('DOMContentLoaded', () => {
    ...
    const scrollAnimatedElements = document.querySelectorAll('.service-iteml, .temoignage-card, .stat-item, .avantage-iteml, .valeur-cardl');
    const titleAnimatedElements = document.querySelectorAll('.section-title, .valeur-cardr, .service-itemr, .avantage-itemr');
